...
public class FitnessClass {
    ...
    public String displayClassAsString() {
        StringBuilder sb = new StringBuilder();
        sb.append("Class: ").append(className).append("\n");
        sb.append("Trainer: ").append(trainer.getName()).append("\n");
        ...
        if (enrolledMembers.isEmpty()) {
            sb.append("Enrolled Members: none\n");
        } else {
            sb.append("Enrolled Members:\n");
            for (Member m : enrolledMembers) {
                sb.append(" - ").append(m.getName())
                        .append(" (").append(membershipToString(m.getMembershipType())).append(")\n");
            }
        }
