...
public class Staff {
     ...
     * @param name Old.StaffManagement.Staff name
     * @param age Old.StaffManagement.Staff age
    ...
    /*
     * @return Old.StaffManagement.Staff name
     */
    ...
    /*
     * @return Old.StaffManagement.Staff age
     */
    public int getAge() 
    { 
        return age; 
    ...
    /*
     * @return Old.StaffManagement.Staff Phone Number
     */
    ...
    /*
     * @return Old.StaffManagement.Staff ID
     */
    ...
    /*
     * @return Old.StaffManagement.Staff rank as a number
     */
    ...
    /*
     * Sets the staff rank (defaults to General Old.StaffManagement.Staff if invalid)
    ...
    /*
     * @return Old.StaffManagement.Staff rank in readable text
     */
    public String getStaffRankName() {
        switch (staffRank) {
            case 2: return "Assistant Manager";
            case 3: return "Manager";
            default: return "General Old.StaffManagement.Staff";
        }
    }
