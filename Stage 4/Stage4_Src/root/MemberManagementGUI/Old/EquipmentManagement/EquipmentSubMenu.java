...
public class EquipmentSubMenu implements GymMenu {
     ...
     *
     * @param eq The Old.EquipmentManagement.EquipmentManager used to handle all equipment actions.
     */
    ...
    public void showMenu(){
        while(true){
            System.out.println("\n ====== Old.EquipmentManagement.Equipment Management Menu ======");
            System.out.println("1. Create New Old.EquipmentManagement.Equipment");
            System.out.println("2. Remove Old.EquipmentManagement.Equipment");
            System.out.println("3. Search Old.EquipmentManagement.Equipment by ID");
            System.out.println("4. Update Old.EquipmentManagement.Equipment Information");
            System.out.println("5. Display All Old.EquipmentManagement.Equipment");
            System.out.println("6. Return to MemberManagementGUI.Main Menu");
