...
public class EquipmentManager {
    ...
    /*
     * Creates a new Arraylist where Reg and Spec Old.EquipmentManagement.Equipment will be stored.
     */
    ...
    public void addEquipment(Equipment neweq)
    {
        ...
        System.out.println("Old.EquipmentManagement.Equipment was added Succesfully");
    }
    ...
    public Equipment searchEquipment(Integer id)
    {
        ...
        System.out.println("Old.EquipmentManagement.Equipment piece not found");
        return null;
    }
    ...
    public boolean updateEquipment(Integer id, String newName, int newAvglife){
        ...
        if (e instanceof SpecializedEquipment){
            System.out.println("Specialized Old.EquipmentManagement.Equipment Updated Successfully");
             ...
             System.out.println("Old.EquipmentManagement.Equipment Updated Successfully");
        }
        return true;
    }
