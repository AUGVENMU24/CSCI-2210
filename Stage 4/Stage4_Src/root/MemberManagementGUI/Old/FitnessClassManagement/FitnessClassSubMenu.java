...
public class FitnessClassSubMenu implements GymMenu {
     ...
     * @param tm TrainerManagement.TrainerManager used for trainer actions
     * @param sm Old.StaffManagement.StaffManager used for staff actions
     * @param mem MemberManagement.MemberManager used for member actions
     * @param fcm Old.FitnessClassManagement.FitnessClassManager used for class actions
     */
    ...
    public void showMenu() {
        ...
        while (true) {
            ...
            System.out.println("5. Sign MemberManagement.Member Up for Class");
            System.out.println("6. Cancel Class");
            System.out.println("7. Show TrainerManagement.Trainer Schedule");
            System.out.println("8. Return to MemberManagementGUI.Main Menu");
