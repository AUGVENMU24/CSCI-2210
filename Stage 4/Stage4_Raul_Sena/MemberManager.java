...
//import MemberManagement.MemberManagement.MemberSubMenuManager;
/*
 * 
 * Stage 3
 */
...
public class MemberManager {
    ...
    private static ArrayList<Member> gymMembers;
     ...
     */
    public void addMember(String name, int age, int id, int pin, String phone, String email, int membershipType)
    {
    ...
    public void removeMember(int memberId)
    {
        ...
        if( mem != null)
        {
            ...
            checkedInMembers.remove(mem);
            System.out.println("MemberManagement.Member:" + mem.getName() + " was removed successfully.");
     ...
     */
    public static void displayMembersChart() {
        /*
     ...
     */
    public void changeMembersInfo(Member mem,
                                  String name,
                                  String phone,
                                  String email,
                                  Integer age,
                                  Integer membershipType) {
         {
            ...
            if (membershipType != null) {
                mem.setMembershipType(membershipType);
            }

            System.out.println("Member information updated successfully for: " + mem.getName());
        }

        /*
        Old CLI Implementation

        System.out.print("Enter MemberManagement.Member ID to update: ");
        ...
        System.out.println("MemberManagement.Member information updated successfully.");
         */
    }
     ...
     */
    public void checkInMember(Member mem) {
    ...
    public String membershipToString(int membershipType) {
        String membership = "";
