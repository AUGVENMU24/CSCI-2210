...
public class TrainerManager {
     ...
     */
    public void updateTrainer(int id, String newName, int newAge, String newPhone, int newRank, String newSpecialty) {
        Trainer t = searchTrainer(id);
        if (t != null) {
            t.setName(newName);
            t.setAge(newAge);
            t.setPhoneContact(newPhone);
            t.setStaffRank(newRank);
