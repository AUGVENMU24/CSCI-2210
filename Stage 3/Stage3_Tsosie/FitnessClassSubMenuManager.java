...
public class FitnessClassSubMenuManager {
     ...
     * @param tm TrainerManager for trainer actions
     * @param sm StaffManager for staff actions
     * @param mem MemberManager for member actions
     * @param fcm FitnessClassManager for class actions
     */
    ...
    public void addClass() {
        ...
        System.out.print("Enter Trainer ID (or press Enter to auto assign): ");
        ...
        if (trainerInput.isEmpty()) {
            ...
            for (Trainer t : trainerManager.getAllTrainers()) 
            {
                ...
                {
                    trainer = t;
                    System.out.println("Auto-assigned Trainer: " + t.getName());
                    break;
                }
            }
