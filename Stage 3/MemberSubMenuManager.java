...
public class MemberSubMenuManager {
     ...
     * @param mem MemberManager used for all member actions
     */
    ...
    public void addMember() {
        ...
        System.out.println("\nPayment added for Member " + newMember.getName());
    ...
    {
        memberManager.changeMembersInfo();
    }
    ...
    {
        System.out.print("Enter Member ID to update PIN: ");
        int id = Integer.parseInt(input.nextLine());
