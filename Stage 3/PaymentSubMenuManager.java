...
public class PaymentSubMenuManager {
     ...
     * @param pay PaymentManager used for payment actions
     */
    ...
    public void addPayment() {
        ...
        System.out.println("Payment added for " + mem.getName());
    ...
    public void searchPayment() {
        ...
        if (payment != null) 
        {
            System.out.println("\nPayment Info for " + payment.getMember().getName());
    ...
    public void updatePayment() {
        System.out.print("Enter Member ID to update payment: ");
        int memberId = Integer.parseInt(input.nextLine());
